...
var yeardates = 169; // Number of calendar days from first game to last game (width of top row)
var yeardays = 24 // Number of weeks from first to last inclusive (count of number of cells in second row)
var yeargames = 47; // Number of game dates in the year (count of number of cells in third row)
var firstdate = new Date(2024, 4, 11); // May = '04'
var plength;
var pcode = new Array();
...
// url for API to GET BrownJacketAvailaility
  var getavail_api_url = "https://yo6lbyfxd1.execute-api.us-east-1.amazonaws.com/prod/getavailability";
...
// 'data' is existing availability data
  ...
  console.log("url is ", url, " requestOptions are ", requestOptions);
...
// Add player names to first header row
  ...
  month_name = document.createTextNode("May (Bruce M)");
  month_cell.appendChild(month_name);
  month_row.appendChild(month_cell);
  
  month_cell = document.createElement("th");
  month_cell.colSpan="9";
  monthname = document.createTextNode("June (Ben)");
  month_cell.appendChild(monthname);
  month_row.appendChild(month_cell);
  
  month_cell = document.createElement("th");
  month_cell.colSpan="9";
  month_name = document.createTextNode("July (TBD)");
  month_cell.appendChild(month_name);
  month_row.appendChild(month_cell);
  
  month_cell = document.createElement("th");
  month_cell.colSpan="9";
  month_name = document.createTextNode("August (TBD)");
  month_cell.appendChild(month_name);
  month_row.appendChild(month_cell);
  
  month_cell = document.createElement("th");
  month_cell.colSpan="8";
  monthname = document.createTextNode("September (TBD)");
  month_cell.appendChild(monthname);
  month_row.appendChild(month_cell);
  
  month_cell = document.createElement("th");
  month_cell.colSpan="9";
  month_name = document.createTextNode("October (TBD)");
  month_cell.appendChild(month_name);
  month_row.appendChild(month_cell);
